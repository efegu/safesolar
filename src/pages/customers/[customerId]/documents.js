      ...
      <div className="lg:pl-72">
        ...
        <div className="w-40 h-screen bg-white text-black p-5 fixed">
          <ul className="text-sm">
            <li className="mb-3">
              <Link href={`/customers/${router.query.customerId}/information`}>
                Kunduppgifter
              </Link>
            </li>
            <li className="mb-3">
              <Link href={`/customers/${router.query.customerId}/products`}>
                Produkter
              </Link>
            </li>
            <li className="mb-3">
              <Link href={`/customers/${router.query.customerId}/documents`}>
                Dokument
              </Link>
            </li>
          </ul>
        ...
        <main className="pt-4 pb-10 ml-40">
          ...
          <div className="flex items-center mt-8 px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
              ...
              >
                Skapa systemdokument
              </button>
            </div>
          </div>

          {/* page body Customer Dokument */}
          <div className="px-4 sm:px-6 lg:px-8">
            {/* Table Customer Systemdokument */}
            ...
            {/* Table Customer Upladdade Dokument*/}
